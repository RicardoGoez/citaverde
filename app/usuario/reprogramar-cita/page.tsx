...
function ReprogramarCitaContent() {
  ...
  const generarDiasDelCalendario = () => {
    ...
    for (let i = 1; i <= diasEnMes; i++) {
      ...
      // Verificar si es pasado (comparar fechas en hora local)
            ...
            <Card className="border border-blue-200 bg-blue-50">
              ...
              <CardContent>
                <div className="space-y-2 text-gray-700">
                  ...
                  <div><strong>Fecha actual:</strong> {formatearFechaLocal(cita.fecha, { weekday: 'long', day: 'numeric', month: 'long' })}</div>
