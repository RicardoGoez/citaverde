...
import { getCitas, getUsuarios, getServicios, getProfesionales, getSedes, updateCita, deleteCita, createCita } from "@/lib/actions/database";
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (isEditing) {
        ...
        // Buscar el profesional si está seleccionado
