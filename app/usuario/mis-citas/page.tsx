...
import { getCitas, updateCita, getProfesionales, getSedes } from "@/lib/actions/database";
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 text-sm text-gray-600 mb-1">
                              ...
                              {new Date(cita.fecha).toLocaleDateString('es-ES', { weekday: 'long', day: 'numeric', month: 'long' })} a las {cita.hora}
                            </div>
                        ...
                        {cita.qr_code && (
                          ...
                          <Button size="sm" variant="outline" className="border-[#16A34A] text-[#16A34A] hover:bg-[#16A34A] hover:text-white" asChild>
                            ...
                            <Button 
                              ...
                              onClick={() => {
                                // Redirigir a página de QR para regenerarlo
                                window.open(`/usuario/qr?cita=${cita.id}&reemitir=true`, '_blank');
                              }}
                            >
          ...
          <div className="space-y-4 py-4">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <p className="text-sm text-blue-700">
                📅 {citaAReprogramar?.fecha && new Date(citaAReprogramar.fecha).toLocaleDateString('es-ES', { weekday: 'long', day: 'numeric', month: 'long' })}
              </p>
              <p className="text-sm text-blue-700">
          ...
          <div className="space-y-4 py-4">
            {citaAEvaluar && (
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600">{new Date(citaAEvaluar.fecha).toLocaleDateString('es-ES')} a las {citaAEvaluar.hora}</p>
              </div>
            )}
            <div>
